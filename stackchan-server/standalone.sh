...
CONVERSATION_HISTORY_ENABLED=$(bool_value "${STACKCHAN_CONVERSATION_HISTORY_ENABLED:-}" false)
CONVERSATION_HISTORY_DAYS=$(int_value "${STACKCHAN_CONVERSATION_HISTORY_DAYS:-}" 90)
CONVERSATION_CONTEXT_MESSAGES=$(int_value "${STACKCHAN_CONVERSATION_CONTEXT_MESSAGES:-}" 20)
CONVERSATION_IDLE_SECONDS=$(int_value "${STACKCHAN_CONVERSATION_IDLE_SECONDS:-}" 15)
